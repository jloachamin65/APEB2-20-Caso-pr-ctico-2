...
public class ArquitecturaFactory {

    private static final ArquitecturaFactory ARQ_FACTORY = new ArquitecturaFactory();
    private ApplicationContext context = null;

    private ArquitecturaFactory() {
    ...
    public static ArquitecturaFactory getInstance() {
        return ARQ_FACTORY;
    }
