...
public class SituacionDaoImpl extends HibernateRepository implements SituacionDao {
    @Override
    public PagedResult<Situacion> listarPaginado(FilterParam filterParam) throws RefugioSearchException {
        ...
        Criteria criteriCount = getSession().createCriteria(Situacion.class);
        ...
        try {
            ...
            if (numRows != null && numRows > 0) {
                lista = new PagedResult<Situacion>();
                Criteria criteria = getSession().createCriteria(Situacion.class);
