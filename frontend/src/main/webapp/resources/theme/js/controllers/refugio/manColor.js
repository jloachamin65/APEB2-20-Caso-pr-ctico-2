app.controller('MantenimientoColor', ['blockUI', '$translate',
    ...
    function (blockUI, $translate, $scope, ngTableParams, $http, Alertify, ngNotify) {
        ...
        controller.tableParams = new ngTableParams({
            ...
            getData: function ($defer, params) {
                ...
                blockUI.start();
                var response = $http.post('listarColorPaginado_json.json', paramFilter);
        ...
        controller.guardar = function (obj) {
            ...
            blockUI.start();
            var response = $http.post('registrarColor_json.json', controller.objInsertar);
            response.success(function (data, status, headers, config) {
        ...
        controller.eliminar = function (obj) {
            ...
            var response = $http.post('eliminarColor_json.json', controller.objEliminar);
            response.success(function (data, status, headers, config) {
