app.controller('MantenimientoHorario', ['blockUI', '$translate',
    ...
    function (blockUI, $translate, $scope, ngTableParams, $http, Alertify, ngNotify) {
        ...
        controller.formatoFechaCalendario = "DD/MM/YYYY";
        ...
        controller.tableParams = new ngTableParams({
            ...
            getData: function ($defer, params) {
                ...
                blockUI.start();
                var response = $http.post('listarHorarioPaginado_json.json', paramFilter);
        ...
        controller.guardar = function (obj) {
            ...
            controller.objInsertar.fecha = new Date(angular.copy(obj.fecha));
            blockUI.start();
            var response = $http.post('registrarHorario_json.json', controller.objInsertar);
            response.success(function (data, status, headers, config) {
        ...
        controller.eliminar = function (obj) {
            ...
            blockUI.start();
            controller.objEliminar.fecha = new Date(angular.copy(obj.fecha));
            var response = $http.post('eliminarHorario_json.json', controller.objEliminar);
            response.success(function (data, status, headers, config) {
        ...
        controller.listaTipos = function () {
            ...
            var response = $http.post('listarHorario_json.json');
            response.success(function (data, status, headers, config) {
