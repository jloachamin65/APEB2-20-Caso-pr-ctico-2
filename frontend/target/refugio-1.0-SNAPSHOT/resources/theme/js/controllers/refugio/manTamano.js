app.controller('MantenimientoTamano', ['blockUI', '$translate',
    ...
    function (blockUI, $translate, $scope, ngTableParams, $http, Alertify, ngNotify) {
        ...
        controller.tableParams = new ngTableParams({
            ...
            getData: function ($defer, params) {
                ...
                blockUI.start();
                var response = $http.post('listarTamanoPaginado_json.json', paramFilter);
        ...
        controller.guardar = function (obj) {
            ...
            blockUI.start();
            var response = $http.post('registrarTamano_json.json', controller.objInsertar);
            response.success(function (data, status, headers, config) {
        ...
        controller.eliminar = function (obj) {
            ...
            var response = $http.post('eliminarTamano_json.json', controller.objEliminar);
            response.success(function (data, status, headers, config) {
        ...
        controller.listaTipos = function () {
            ...
            var response = $http.post('listarTamano_json.json', controller.objEliminar);
            response.success(function (data, status, headers, config) {
