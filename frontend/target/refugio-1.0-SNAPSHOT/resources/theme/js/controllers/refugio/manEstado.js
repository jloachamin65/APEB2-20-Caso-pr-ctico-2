app.controller('MantenimientoEstado', ['blockUI', '$translate',
    ...
    function (blockUI, $translate, $scope, ngTableParams, $http, Alertify, ngNotify) {
        ...
        controller.tableParams = new ngTableParams({
            ...
            getData: function ($defer, params) {
                ...
                blockUI.start();
                var response = $http.post('listarEstadoPaginado_json.json', paramFilter);
        ...
        controller.guardar = function (obj) {
            ...
            blockUI.start();
            var response = $http.post('registrarEstado_json.json', controller.objInsertar);
            response.success(function (data, status, headers, config) {
        ...
        controller.eliminar = function (obj) {
            ...
            var response = $http.post('eliminarEstado_json.json', controller.objEliminar);
            response.success(function (data, status, headers, config) {
        ...
        controller.listaTipos = function () {
            ...
            var response = $http.post('listarEstado_json.json', controller.objEliminar);
            response.success(function (data, status, headers, config) {
